...
int zmk_widget_status_init(struct zmk_widget_status *widget, lv_obj_t *parent) {
    ...
    lv_obj_set_size(brand_canvas, 68, 68);
    lv_obj_align(brand_canvas, LV_ALIGN_BOTTOM_RIGHT, 28, 0);
    lv_canvas_set_buffer(brand_canvas, brand_cbuf, CANVAS_SIZE, CANVAS_SIZE, LV_IMG_CF_TRUE_COLOR);
    update_brand_label();
